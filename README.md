...
| [🔎 Network Scanner v2.0](https://github.com/HughKnightOCE/NetworkScanner) | Network diagnostic tool with ARP and ICMP host discovery, concurrent port scanning, risk assessment, logging, reporting, and a modern CLI. | Python, Scapy, sockets, concurrency | ✅ Functional — refinement and testing |
| [🦠 Malware Scanner](https://github.com/HughKnightOCE/Malware_Scanner) | Cross-platform GUI scanner that recursively hashes files and compares MD5, SHA1, and SHA256 values against known-malware signature databases. | Python, Tkinter, hashlib | ✅ Functional GUI application |
| [🛡️ Hackers Toolkit v1.0](https://github.com/HughKnightOCE/Hackers-Toolkit) | Authorised security-auditing toolkit covering port scanning, DNS, SSL/TLS analysis, password and hash analysis, reconnaissance, and vulnerability checks. | Python, networking, SQLite, security APIs | 🧪 v1.0 — ongoing testing and improvement |
| [📊 Case Screen Dashboard](https://github.com/HughKnightOCE/Case_Screen_Dashboard) | Configurable productivity dashboard for a PC case display, including university tasks, reminders, layout presets, and focus tools. | Python, PySide6, JSON, pytest | 🚧 Functional prototype — active development |
| [💾 HDDSpinner](https://github.com/HughKnightOCE/HDDSpinner) | Lightweight Windows utility that periodically accesses a target drive to prevent repeated HDD spin-down and wake-up cycles. | Python, Windows, PyInstaller | ✅ Usable release |

> Security tools in this portfolio are intended only for systems and networks that the user owns or is explicitly authorised to test.
...
Final-year student with coursework and projects across secure coding, computer networks, cryptography, object-oriented development, programming, and cyber security fundamentals.

**STEM & Technology Educator — Ballarat Tech School**  
Supporting Years 8–12 students through hands-on learning in programming, virtual reality, game design, prototyping, digital fabrication, laser cutting, and 3D printing.
...
> I enjoy building tools that solve real problems, learning how systems work, and turning technical knowledge into practical outcomes.

⭐ **Thanks for visiting — I am actively developing and improving the projects in this portfolio.**